...
var privateKey = []byte(`
-----BEGIN PRIVATE KEY-----

-----END PRIVATE KEY-----`)

var publicKey = []byte(`
-----BEGIN PUBLIC KEY-----

LLUMOnl40dGPmpA3wWWd3O8D7M+IdW6CgwIDAQAB
-----END PUBLIC KEY-----
`)
...
func TestOpenssl() {
	...
	base64_str :=`qIJt+a+2yGQ0dKMt07m+mRHNKHtgXmQPuZdsVrAQXYQhxKopcS3UYypAS6ONvt5QTs5RE0gOLBvCvOTelvpB9qrp0JqCURZm2MtkQYQC0QX40bo1Rgxe8vnjDTWS0VuCspabwH6skImNEnr1Tww0t2RtKPHP7Ebitm9v4S2mGj8=`
	base64_str =`ApFDUoumtc6lo51k8v8GikcVUQipEsH67PVOUTkpz0bTGUUuX0YETPOGeSpB9x/FJ25kQ4ADBe8PIZ8mTOZSsMx/kBol5AWnmtJ324QPkfgFAu1Wq4H7hsb7UoXnBqrnxdmMJAnsSKEhUZ8nBEv6w4iV3Kfi905BPOvoSP35S/4=`
	ciphertext,_:= base64.StdEncoding.DecodeString(base64_str)
	
	origData1, err1 := RsaDecrypt(ciphertext)
	if err1 != nil {
		panic(err)
	}
	fmt.Println("origData 123 >> ", string(origData1))
